...

{
  ...
  systemd.tmpfiles.rules = [
    ...
    "d /var/lib/forgejo/custom/templates 0755 forgejo forgejo - -"
    "d /var/lib/forgejo/custom/templates/custom 0755 forgejo forgejo - -"
    ...
    "L+ /var/lib/forgejo/custom/public/assets/css/custom-logo.css - - - - ${./forgejo-themes/custom-logo.css}"
    ...
    "L+ /var/lib/forgejo/custom/templates/custom/header.tmpl - - - - ${./forgejo-themes/header.tmpl}"
  ];
}
